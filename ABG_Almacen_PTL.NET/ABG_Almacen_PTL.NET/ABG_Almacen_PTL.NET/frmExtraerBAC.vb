...
Public Class frmExtraerBAC
    Inherits Form

    ' ----- Constantes de Módulo (igual que VB6) -------------
    Private Const MOD_Nombre As String = "Extraer BAC"
    ...
    Private Sub InitializeComponent()
        ...
        Me.Text = "Extraer BAC"                     ' Caption = "Extraer BAC"
        ...
        oEstado(0).Checked = True                   ' Value = -1 'True
        ...
        Picture1.Controls.AddRange(New Control() {oEstado(0), oEstado(1)})
        ...
        lbBAC.Size = New Size(112, 19)              ' 1680/15

        lbEstadoBAC = New Label()
        lbEstadoBAC.BackColor = Color.White
        lbEstadoBAC.TextAlign = ContentAlignment.MiddleCenter
        lbEstadoBAC.Location = New Point(176, 30)   ' 2640/15
        lbEstadoBAC.Size = New Size(61, 19)         ' 915/15
    ...
    Private Function fValidarBAC(ByVal stBAC As String, Optional ByVal blMensaje As Boolean = True) As Boolean
        ...
        Try
            ...
            If dtBAC.Rows.Count > 0 Then
                ...
                ' Extracción del BAC
                If uninum > 0 Then
                    If RetirarBAC(unicod, uniest, oEstado(0).Checked) Then
                        wsMensaje(" Se ha extraído el BAC: " & unicod & " de su ubicación de PTL ", TipoMensaje.MENSAJE_Exclamacion)
                    End If
                Else
                    If (uniest = 0) = oEstado(0).Checked Then
                        If oEstado(0).Checked Then tEstado = 1 Else tEstado = 0
                        ...
                        End If
                    Else
                        wsMensaje(" El BAC ya está fuera de las ubicaciones de PTL ", TipoMensaje.MENSAJE_Grave)
                    End If
                End If
            Else
                Exit Function
    ...
    Private Function RetirarBAC(tBac As String, tEstado As Integer, tEstadoFinal As Boolean) As Boolean
        ...
        Try
            ...
            If Retorno = 0 Then
                ...
                End If
            Else
                wsMensaje(" No se ha podido retirar el BAC de la estanteria de PTL. " & msgSalida, TipoMensaje.MENSAJE_Grave)
            End If
        Catch ex As Exception
            wsMensaje($" Error al retirar BAC: {ex.Message}", TipoMensaje.MENSAJE_Grave)
        End Try
